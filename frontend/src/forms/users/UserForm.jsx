      ...
      >
        ...
        {newImage != 0 && image == '' && (
          <Box className='user-form-avatar-container'>
            ...
            <Button className='user-form-button' variant='contained' onClick={handleDeleteNewImage}>
              Delete Image
            </Button>
          </Box>
        )}
        {newImage == 0 && image != '' && (
          <Box className='user-form-avatar-container'>
            <Avatar className='user-form-avatar' src={'http://localhost:3000' + image} />
            <Button className='user-form-button' variant='contained' onClick={handleDeleteImage}>
              Delete Image
            </Button>
          </Box>
        )}
        ...
        ></TextField>
        <Button className='user-form-button' variant='contained' type='submit'>
          {buttonMessage}
        </Button>
      </form>
    </Card>
